...
@__DSOCacheEntry_name.6 = internal constant [23 x i8] c"libaot-TrackApp.dll.so\00", align 1
...
@__DSOCacheEntry_name.44 = internal constant [31 x i8] c"libaot-Maui.TouchEffect.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [464 x %struct.DSOCacheEntry] [
	...
	; 5
	%struct.DSOCacheEntry {
		i64 97793449, ; hash 0x5d435a9, from name: aot-TrackApp
		i8 0, ; ignore
	...
	; 30
	%struct.DSOCacheEntry {
		i64 304373498, ; hash 0x12245efa, from name: libaot-TrackApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 62
	%struct.DSOCacheEntry {
	...
	; 76
	%struct.DSOCacheEntry {
		i64 787809785, ; hash 0x2ef505f9, from name: TrackApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 116
	%struct.DSOCacheEntry {
		i64 1131848966, ; hash 0x4376a506, from name: aot-TrackApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 156
	%struct.DSOCacheEntry {
		i64 1468102242, ; hash 0x57817662, from name: libaot-TrackApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 405
	%struct.DSOCacheEntry {
		i64 3767780886, ; hash 0xe093c616, from name: TrackApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
