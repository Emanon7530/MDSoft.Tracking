...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"fc7ca759-a6c0-446e-bd7d-b9ad16a6272b\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [25 x i8] c"com.companyname.trackapp\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100672048, ; jnienv_initialize_method_token
	i32 100672047, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.34 = internal constant [31 x i8] c"libaot-Maui.TouchEffect.dll.so\00", align 16
...
@__DSOCacheEntry_name.66 = internal constant [23 x i8] c"libaot-TrackApp.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [464 x %struct.DSOCacheEntry] [
	...
	; 142
	%struct.DSOCacheEntry {
		i64 6630463590383331418, ; hash 0x5c04238178f5a85a, from name: TrackApp.dll.so
		i8 0, ; ignore
	...
	; 302
	%struct.DSOCacheEntry {
		i64 12486755222872393654, ; hash 0xad49ddb7b09007b6, from name: libaot-TrackApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.66, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 358
	%struct.DSOCacheEntry {
		i64 14242923101613170154, ; hash 0xc5a9071942db9dea, from name: TrackApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.66, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 393
	%struct.DSOCacheEntry {
		i64 15624734965068592957, ; hash 0xd8d635aad689f73d, from name: aot-TrackApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.66, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 412
	%struct.DSOCacheEntry {
		i64 16380862820010904740, ; hash 0xe35483f1fd274ca4, from name: aot-TrackApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.66, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 431
	%struct.DSOCacheEntry {
		i64 17088407929663995911, ; hash 0xed26387948974007, from name: libaot-TrackApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.66, i32 0, i32 0), ; name
		i8* null; handle
	}, 
